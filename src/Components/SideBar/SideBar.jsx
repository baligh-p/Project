                ...
                <div className='t-w-full t-flex t-overflow-x-hidden'>
                    <div className={`linksContainer ${showSecondSideBar ? "-t-ml-[100%]" : "t-ml-0"} t-z-10 t-w-full t-flex-none t-whitespace-nowrap t-duration-200 t-flex t-flex-col t-justify-start t-items-start`}>
                        <Link onClick={closeSideBar} to="/" className='stat t-select-none t-text-body t-cursor-pointer t-w-full hover:t-relative hover:t-left-1  t-px-2 t-rounded-md t-py-2 t-mx-auto t-flex t-space-x-3 t-items-center'>
                            ...
                            <h3 className='t-text-body lg:t-text-[14px] t-text-[15px] t-tracking-wider'>Statistiques</h3>
                        </Link>
                        <Link to={"/IP_List/" + (direction ? direction : directions[0])} onClick={() => { setShowSecondSideBar(true) }} className='IP_List t-select-none t-text-body t-cursor-pointer hover:t-relative hover:t-left-1 t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                            ...
                            <h3 className='t-ml-3 t-text-body lg:t-text-[14px] t-text-[15px] t-tracking-wider'>Liste des Adresses IP</h3>
                        ...
                        <Link onClick={closeSideBar} to="/History" className='hist t-select-none t-text-body hover:t-ml-1 t-cursor-pointer t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                            ...
                            <h3 className='t-ml-3 t-text-body lg:t-text-[14px] t-text-[15px] t-tracking-wider'>Historique</h3>
                        </Link>
                        <Link onClick={closeSideBar} to="/Add_Types" className='typesLink t-select-none t-text-body hover:t-ml-1 t-cursor-pointer t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                            ...
                            <h3 className='t-ml-3 t-text-body lg:t-text-[14px] t-text-[15px] t-tracking-wider'>Ajouter une Type</h3>
                        </Link>
                        <Link onClick={closeSideBar} to="/Add_Marks" className='marks t-select-none t-text-body hover:t-ml-1 t-cursor-pointer t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"><path d="M11.25 18.75v-6h-6v-1.5h6v-6h1.5v6h6v1.5h-6v6Z" /></svg>
                            <h3 className='t-ml-3 t-text-body lg:t-text-[14px] t-text-[15px] t-tracking-wider'>Ajouter une Marque</h3>
                        </Link>
                        <Link onClick={closeSideBar} to="/Add_D" className='DirLink t-select-none t-text-body hover:t-ml-1 t-cursor-pointer t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                            ...
                            <h3 className='t-ml-3 t-text-body lg:t-text-[14px] t-text-[15px] t-tracking-wider'>Ajouter une Direction</h3>
                        </Link>
                        {user?.role == "ROLE_ADMIN" && <Link onClick={closeSideBar} to="/Add_User" className='addUser t-select-none t-text-body hover:t-ml-1 t-cursor-pointer t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                            ...
                            <h3 className='t-ml-3 t-text-body lg:t-text-[14px] t-text-[15px] t-tracking-wider'>Ajouter un Utilisateur</h3>
                        </Link>}
                        <Link onClick={closeSideBar} to="/MyProfile" className='myPF t-select-none hover:t-relative hover:t-left-1 t-text-body t-cursor-pointer  t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                            ...
                            <h3 className='t-ml-3 t-text-body lg:t-text-[14px] t-text-[15px] t-tracking-wider'>{(user.username) && (user.username) || ""}</h3>
                        </Link>
                        <div onClick={logout} className='deconnecter hover:t-text-white hover:t-fill-white t-duration-200 t-delay-75 t-select-none t-text-body t-cursor-pointer t-w-full t-px-2 t-text-red-500 t-fill-red-500 t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                            ...
                            <h3 className='t-ml-3 t-text-body lg:t-text-[14px] t-text-[15px] t-tracking-wider'>Se Deconnecter</h3>
                        </div>
                    </div>
                    <div className={`customScrollBar t-w-full lg:t-h-[75vh] t-h-[82vh] t-flex-none t-flex t-whitespace-nowrap t-duration-300 t-delay-75 t-overflow-x-hidden t-overflow-y-scroll t-flex-col t-items-start`}>
                        {directions?.map((element, index) => {
                            return <Link onClick={closeSideBar} key={index} to={"/IP_List/" + element} className={`${element} t-select-none hover:t-relative t-text-body t-cursor-pointer  t-w-[98%] t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center`}>
                                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24">
                                    <path d="M3.25 20.575v-13.5h4v-4h9.5v8h4v9.5h-7.5v-4h-2.5v4Zm1.5-1.5h2.5v-2.5h-2.5Zm0-4h2.5v-2.5h-2.5Zm0-4h2.5v-2.5h-2.5Zm4 4h2.5v-2.5h-2.5Zm0-4h2.5v-2.5h-2.5Zm0-4h2.5v-2.5h-2.5Zm4 8h2.5v-2.5h-2.5Zm0-4h2.5v-2.5h-2.5Zm0-4h2.5v-2.5h-2.5Zm4 12h2.5v-2.5h-2.5Zm0-4h2.5v-2.5h-2.5Z" />
                                </svg>
                                <h3 className='t-ml-3 t-text-body lg:t-text-[14px] t-text-[15px] t-tracking-wider'>{element}</h3>
                            </Link>
                        })}
                    </div>
