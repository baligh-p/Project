...
const SideBar = () => {
    ...
    useEffect(() => {
        ...
        else if (location.pathname.split("/").filter(element => element != "").find(element => element == "types")) {
            document.querySelector(".types").classList.replace("notSelectedLink", "selectedLink")
            setShowSecondSideBar(() => false)
        }
        else if (location.pathname.split("/").filter(element => element != "").find(element => element == "marks")) {
    ...
    return (
        <div className='t-w-[20.5%] t-z-50 t-fixed t-top-0 t-left-0 t-bg-[#202020] t-h-full t-px-5 t-py-3'>
            <div className='t-mt-1 t-flex t-items-center lg:t-w-auto t-w-full t-bg-[#202020] lg:t-static t-fixed t-top-0 t-left-0'>
                <div id="burger"><div className="burgerLight t-flex lg:t-hidden t-z-20"></div></div>
                <h1 className='t-text-white t-text-bold t-tracking-widest t-text-[27px] '>WebSite</h1>
                {(showSecondSideBar) && (<div onClick={() => {
                    setShowSecondSideBar(() => false)
                }} className='t-ml-auto t-relative t-top-1 t-cursor-pointer'>
            ...
            <div className='t-w-full t-mx-auto t-h-[1px] t-bg-neutral-500 t-my-5'></div>
            <div className='t-w-full t-flex t-overflow-hidden'>
                <div className={`linksContainer ${showSecondSideBar ? "-t-ml-[100%]" : "t-ml-0"} t-z-10 t-w-full t-flex-none t-whitespace-nowrap t-duration-300 t-delay-75 t-overflow-hidden t-flex t-flex-col t-justify-start t-items-start`}>
                    <Link to="/" className='stat t-select-none t-text-body t-cursor-pointer t-w-full hover:t-relative hover:t-left-1  t-px-2 t-rounded-md t-py-2 t-mx-auto t-flex t-space-x-3 t-items-center'>
                        ...
                        <h3 className='t-text-body t-text-[14px] t-tracking-wider'>Statistiques</h3>
                    </Link>
                    <Link onClick={() => { setShowSecondSideBar(() => true) }} to={"/IP_List/" + directions[0]} className='IP_List t-select-none t-text-body t-cursor-pointer hover:t-relative hover:t-left-1 t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24">
                        ...
                        <h3 className='t-ml-3 t-text-body t-text-[14px] t-tracking-wider'>Liste des Adresses IP</h3>
                    ...
                    <Link to="/History" className='hist t-select-none t-text-body hover:t-ml-1 t-cursor-pointer t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24">
                        ...
                        <h3 className='t-ml-3 t-text-body t-text-[14px] t-tracking-wider'>Historique</h3>
                    </Link>
                    <Link to="/types" className='types t-select-none t-text-body hover:t-ml-1 t-cursor-pointer t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"><path d="M2.5 19.375v-2.25h2V6.3q0-.775.525-1.3T6.3 4.475h14.45v1.5H6.3q-.125 0-.212.1Q6 6.175 6 6.3v10.825h5.75v2.25Zm12.9 0q-.375 0-.638-.25-.262-.25-.262-.625V9.25q0-.375.262-.625.263-.25.638-.25h5.225q.375 0 .625.25t.25.625v9.25q0 .375-.25.625t-.625.25Zm.6-2.25h4v-7.25h-4Z" /></svg>
                        <h3 className='t-ml-3 t-text-body t-text-[14px] t-tracking-wider'>Les Types</h3>
                    </Link>
                    <Link to="/marks" className='marks t-select-none t-text-body hover:t-ml-1 t-cursor-pointer t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"><path d="M2.5 19.375v-2.25h2V6.3q0-.775.525-1.3T6.3 4.475h14.45v1.5H6.3q-.125 0-.212.1Q6 6.175 6 6.3v10.825h5.75v2.25Zm12.9 0q-.375 0-.638-.25-.262-.25-.262-.625V9.25q0-.375.262-.625.263-.25.638-.25h5.225q.375 0 .625.25t.25.625v9.25q0 .375-.25.625t-.625.25Zm.6-2.25h4v-7.25h-4Z" /></svg>
                        <h3 className='t-ml-3 t-text-body t-text-[14px] t-tracking-wider'>Les Marques</h3>
                    </Link>
                    <Link to="/Add_User" className='addUser t-select-none t-text-body hover:t-ml-1 t-cursor-pointer t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24">
                        ...
                        <h3 className='t-ml-3 t-text-body t-text-[14px] t-tracking-wider'>Ajouter un Utilisateur</h3>
                    </Link>
                    <Link to="/MyProfile" className='myPF t-select-none hover:t-relative hover:t-left-1 t-text-body t-cursor-pointer  t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24">
                        ...
                        <h3 className='t-ml-3 t-text-body t-text-[14px] t-tracking-wider'>Mon Profil</h3>
                    </Link>
                    <div className='deconnecter hover:t-text-white hover:t-fill-white t-duration-200 t-delay-75 t-select-none t-text-body t-cursor-pointer t-w-full t-px-2 t-text-red-500 t-fill-red-500 t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
                        ...
                        <h3 className='t-ml-3 t-text-body t-text-[14px] t-tracking-wider'>Se Deconnecter</h3>
                    </div>
                </div>
                <div className={`customScrollBar t-w-full t-h-[75vh] t-flex-none t-flex t-whitespace-nowrap t-duration-300 t-delay-75 t-overflow-x-hidden t-overflow-y-scroll t-flex-col t-items-start`}>
                    {directions.map((element, index) => {
                        return <Link key={index} to={element} className={`${element} t-select-none hover:t-relative t-text-body t-cursor-pointer  t-w-[98%] t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center`}>
                            <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24">
                            ...
                            <h3 className='t-ml-3 t-text-body t-text-[14px] t-tracking-wider'>{element}</h3>
                        </Link>
                    })}
                </div>
                <div className='t-absolute t-z-50 t-w-full t-left-0 t-bg-[#202020] t-bottom-3'>
