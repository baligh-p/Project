...
const SideBar = () => {
    ...
    const toggleSideBar = (e) => {
        ...
        if (sideBar.current.classList.contains("-t-left-full")) sideBar.current.classList.replace("-t-left-full", "t-left-0")
        else {
    ...
    return (
        <div ref={sideBar} className='sideBar lg:t-w-[20.5%] t-w-full t-z-50 t-fixed lg:t-top-0 t-top-[4.3rem] t-duration-500 t-delay-75 lg:t-left-0 -t-left-full  t-bg-[#202020] t-h-full t-px-5 t-py-3'>
            ...
            <div className='t-w-full t-flex t-overflow-hidden'>
                <div className={`linksContainer ${showSecondSideBar ? "-t-ml-[100%]" : "t-ml-0"} t-z-10 t-w-full t-flex-none t-whitespace-nowrap t-duration-200 t-overflow-hidden t-flex t-flex-col t-justify-start t-items-start`}>
                    ...
                    <Link to="/Add_Marks" className='marks t-select-none t-text-body hover:t-ml-1 t-cursor-pointer t-w-full t-px-2  t-rounded-md t-py-2 t-mx-auto t-flex t-items-center'>
