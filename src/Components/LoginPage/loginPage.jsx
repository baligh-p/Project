            ...
            <div className='t-w-full lg:t-fixed t-lg:inset-0 t-min-h-full t-flex t-items-center t-justify-center'>
                <div className='t-min-h-screen lg:t-flex t-hidden t-w-7/12 t-bg-neutral-900 selection:t-bg-white selection:t-text-blue-300'>
                    <div className='t-mx-auto t-relative t-right-10 t-flex t-flex-col t-items-center t-justify-center'>
                        <img className='t-h-[70vh] t-mb-3 t-w-[37vw]' src="/assets/icons/loginration.png" alt="" />
                        <h1 className='t-text-lg t-text-white t-w-10/12 t-text-center t-mx-auto'>Pour Créer Un Compte Veuillez Contacter Le Responsable De Site.</h1>
                    </div>
                </div>
                <div className='selection:t-bg-blue-300 selection:t-text-white t-py-5 lg:t-py-12 lg:t-w-5/12 t-w-full t-shadow-lg t-shadow-black/20 lg:t-relative t-bottom-5 t-rounded-lg t-right-24 t-bg-white t-min-h-screen lg:t-min-h-min t-flex t-flex-col t-items-center t-justify-center'>
                    <div className='t-z-10 lg:t-mb-10 t-mb-20 t-w-full t-flex t-space-y-5 t-flex-col t-items-center t-justify-center'>
                        <h2 className='t-text-blue-400 t-font-bold t-text-5xl lg:t-text-4xl'>Se connecter</h2>
                        <p className='lg:t-text-sm t-text-md t-text-stone-500 lg:t-w-6/12 t-w-10/12 t-text-center '>
                            Veuillez remplir cetter Formulaire avec vos informations personnelles.</p>
                    </div>
                    ...
                    <div className={`t-fill-red-500 lg:t-w-6/12 t-w-10/12 md:t-w-8/12 ${valid ? "t-opacity-0" : ""} t-flex t-items-center t-space-x-1 t-mt-10 t-mb-2 lg:t-mb-2`}>
